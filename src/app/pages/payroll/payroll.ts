...
export class Payroll implements OnInit {
  ...
  loadPayrollData() {
    ...
    this.payrollService
      .getPayrollSummary(monthStr, this.selectedYear)
      .pipe(takeUntilDestroyed(this.destroyRef))
      .subscribe({
    ...
    this.payrollService
      .getPayrollRecords(monthStr, this.selectedYear)
      .pipe(takeUntilDestroyed(this.destroyRef))
      .subscribe({
  ...
  initializePeriod() {
    ...
    this.payrollService
      .initializePayrollPeriod(this.selectedMonth, this.selectedYear)
      .pipe(takeUntilDestroyed(this.destroyRef))
      .subscribe({
        next: (res: any) => {
  ...
  processSelectedPayroll() {
    ...
    const period = { month: this.selectedMonth, year: this.selectedYear };

    this.payrollService
      .processPayroll(this.selectedEmployees, period)
      .pipe(takeUntilDestroyed(this.destroyRef))
      .subscribe({
        next: () => {
  ...
  markAsPaid() {
    ...
    this.payrollService
      .markAsPaid(this.selectedPayroll.id, {
